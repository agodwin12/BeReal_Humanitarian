...
const PAGES = [
  ...
  },
  {
    ...
    path: "/about",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["About.eyebrow", "About.title", "About.lead", "About.heroImageAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-team-photo.jpg" }] },
      ...
      { key: "faith", title: "Faith & service", messageKeys: ["About.faith."], images: [{ slot: "faith", label: "Faith & service photo", default: "/images/outreach-faith-service.jpg" }] },
  ...
  },
  {
    ...
    path: "/programs",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["ProgramsPage.eyebrow", "ProgramsPage.title", "ProgramsPage.lead", "ProgramsPage.heroAlt", "ProgramsPage.quickNavLabel", "ProgramsPage.programLabel", "ProgramsPage.purposeLabel", "ProgramsPage.includesLabel"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-programs-hero.jpg" }] },
  ...
  },
  {
    ...
    path: "/impact",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["ImpactPage.eyebrow", "ImpactPage.title", "ImpactPage.lead", "ImpactPage.heroAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-impact-hero.jpg" }] },
      ...
      { key: "principles", title: "How we report", messageKeys: ["ImpactPage.principles."], images: [{ slot: "principles", label: "Side photo", default: "/images/outreach-principles.jpg" }] },
      CTA_SECTION,
  ...
  },
  {
    ...
    path: "/get-involved",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["GetInvolvedPage.eyebrow", "GetInvolvedPage.title", "GetInvolvedPage.lead", "GetInvolvedPage.heroAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-cta-community.jpg" }] },
  ...
  },
  {
    ...
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["AssistancePage.eyebrow", "AssistancePage.title", "AssistancePage.lead", "AssistancePage.heroAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-health-hope.jpg" }] },
  ...
  },
  {
    ...
    path: "/contact",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["ContactPage.eyebrow", "ContactPage.title", "ContactPage.lead", "ContactPage.heroAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-contact-hero.jpg" }] },
  ...
  },
  {
    ...
    path: "/gallery",
    sections: [
      { key: "hero", title: "Hero", locked: true, messageKeys: ["GalleryPage.eyebrow", "GalleryPage.title", "GalleryPage.lead", "GalleryPage.heroAlt"], images: [{ slot: "hero", label: "Hero photo", default: "/images/outreach-cta-community.jpg" }] },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "cta", title: "Call to action band", messageKeys: ["GetInvolved."], images: [{ slot: "cta", label: "Background photo", default: "/images/outreach-cta-community.jpg" }] },
